...
## Deprecated in this monorepo

This project is archived here as a read-only legacy reference.

Active rewrite work now lives in:
...
Do not add new features in this archived folder unless you are documenting migration context.
