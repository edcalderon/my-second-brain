            ...
            <header className="space-y-5">
                ...
                <div className="space-y-3">
                    ...
                    <p className="max-w-3xl text-gray-600 dark:text-gray-400 transition-colors">
                        A focused workspace for notes, memory graphs, documents, and agents. The second brain now stays separate from the A-Quant portal, which is published at <code className="rounded bg-slate-100 px-1.5 py-0.5 text-[0.9em] text-slate-700 dark:bg-slate-800 dark:text-slate-200">edcalderon.io/a-quant</code>.
                    </p>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <InlineLink href="https://edcalderon.io/" icon={<Globe className="h-4 w-4" />} label="Project Directory" external />
                </div>
            </header>
                ...
                >
                    <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400 transition-colors">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                            ...
                            />
                            <ActionLink
                                href="https://edcalderon.io/a-quant/"
...
function InlineLink({ href, icon, label, external = false }: { href: string; icon: ReactNode; label: string; external?: boolean }) {
    return (
        <Link
            href={href}
            target={external ? "_blank" : undefined}
