...
const config: Config = {
  ...
  baseUrl: '/my-second-brain/documentation/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/edcalderon/my-second-brain/edit/main/apps/docs/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} My Second Brain. Built with Docusaurus.`,
    },
    prism: {
